# This file contains the raw data for the quiz.
# It's a list of dictionaries, where each dictionary represents a question
...
# you can change the data from the Opentrivia api: https://opentdb.com/api_config.php